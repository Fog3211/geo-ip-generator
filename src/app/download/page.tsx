...
function getFileInfo(filename: string): DataFileInfo | null {
  ...
  const fileInfoMap: Record<string, Omit<DataFileInfo, 'size' | 'lastModified' | 'downloadUrl'>> = {
    ...
    ,
    // IPv6 datasets (JSON only for now)
    'combined-geo-ipv6-data.json': {
      name: 'Complete JSON Data (IPv6)',
      description: 'Full IPv6 dataset with country information and IP ranges in JSON format',
      format: 'JSON (IPv6)',
      icon: '📄'
    },
    'combined-geo-ipv6-data.min.json': {
      name: 'Minified JSON Data (IPv6)',
      description: 'Compressed IPv6 JSON format optimized for smaller file size',
      format: 'JSON (IPv6, Min)',
      icon: '🗜️'
    }
  };
...
export default function DownloadPage() {
  const availableFiles = [
    ...
    'combined-geo-ip-data-light.csv',
    'combined-geo-ip-data.xlsx',
    // IPv6 files appear only when generated by CI
    'combined-geo-ipv6-data.json',
    'combined-geo-ipv6-data.min.json'
    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-6">
          ...
          <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm text-green-400 mb-4">
            <div className="mb-2"># Generate 3 China IPv6 addresses</div>
            <div>curl "https://yoursite.com/api/generate-ipv6?country=CN&count=3"</div>
          </div>
